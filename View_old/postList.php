    ...
    <div class="container">
        ...
        <?php foreach ($post as $postKey) :  ?> 
                ...
                <div class="authorpostbox">
                    <div class="card">
                        <a href="author.html">
                        <img class="img-fluid img-thumb" src="<?php echo BASE_URL; ?>media/image/<?= $postKey['image'];?>" alt="">
                        </a>
                        <div class="card-block">
                            <h2 class="card-title"><a href="post.html"><?= $postKey['title'] ?></a></h2>
              <h4 class="card-text"><?= $postKey['text'];?></h4>
                <div class="metafooter">
                                <div class="wrapfooter">
                                    ...
                                    <span class="post-name"><a href="author.html"><?= $postKey['author']; ?></a></span><br/>
